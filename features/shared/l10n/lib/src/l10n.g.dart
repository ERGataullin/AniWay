...
abstract class L10n {
  ...
  ///
  /// In ru, this message translates to:
  /// **'{type, select, tv{{episode} серия} movie{Фильм} ova{OVA {episode}} ona{ONA {episode}} special{Спешл {episode}} tvSpecial{ТВ спешл {episode}} music{Музыка {episode}} pv{Трейлер {episode}} other{{episode} серия}}'**
  String movieEpisode(String type, num episode);

  /// No description provided for @movieType.
  ///
  /// In ru, this message translates to:
  /// **'{type, select, tv{ТВ} movie{Фильм} ova{OVA} ona{ONA} special{Спешл} tvSpecial{ТВ спешл} music{Музыкальное} pv{Трейлер} other{}}'**
