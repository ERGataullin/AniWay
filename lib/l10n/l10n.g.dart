...
abstract class L10n {
  ...
  /// No description provided for @episodesWatchedLabel.
  ///
  /// In ru, this message translates to:
  /// **'Просмотрено серий'**
  String get episodesWatchedLabel;
  ...
  /// No description provided for @ofY.
  ///
  /// In ru, this message translates to:
  /// **'из {y}'**
  String ofY(num y);
  ...
  /// No description provided for @qualityType.
  ///
  /// In ru, this message translates to:
  ...
  ///
  /// In ru, this message translates to:
  /// **'{type, select, raw{Оригинал} sub{Субтитры} voice{Озвучка} other{}}'**
  ...
  /// No description provided for @watchStatusTitle.
  ///
  /// In ru, this message translates to:
  /// **'Добавить в список'**
  ...
  ///
  /// In ru, this message translates to:
  /// **'Не более {episodesCountTotal} серий'**
  String watchStatusEpisodesError(num episodesCountTotal);

  /// No description provided for @watchStatus.
  ///
  /// In ru, this message translates to:
  /// **'{type, select, planned{Запланировано} watching{Смотрю} completed{Просмотрено} onHold{Отложено} dropped{Брошено} other{Неизвестный статус}}'**
